...
const Projects = () => {
  return (
    <section id="project" className="max-w-container mx-auto lgl:px-20 py-24">
      <SectionTitle title="Some Things I have Built" titleNo="γ" />
          ...
          <div className="w-full xl:w-1/2 flex flex-col gap-6 lgl:justify-between items-end text-right xl:-ml-16 z-10">
            ...
            <div className="text-2xl flex gap-4">
              <a
                ...
                href="https://github.com/priparmot"
                target="_blank"
              >
                <TbBrandGithub />
              </a>
        ...
        <div className="flex flex-col xl:flex-row-reverse gap-6">
          ...
          <div className="w-full xl:w-1/2 flex flex-col gap-6 justify-between items-end text-right z-10">
            <div>
              ...
              <h3 className="text-2xl font-bold">สนาม แห่งความมุ่งมั่น</h3>
            </div>
            <p className="text-sm md:text-base bg-[#112240] p-2 md:p-6 rounded-md xl:-mr-16">
              ย้อนกลับไปเมื่อเดือนพฤศจิกายน ปี 2020 ทีมฟุตบอลชายของลิเวอร์พูล
              ได้ประเดิมเข้าฝึกซ้อมที่ AXA training centre
              ศูนย์ฝึกแห่งใหม่ของสโมสร{" "}
            ...
            <div className="text-2xl flex gap-4">
              <a
                className="hover:text-textGreen duration-300"
                href="https://github.com/pripramot"
                target="_blank"
              >
                <TbBrandGithub />
              </a>
